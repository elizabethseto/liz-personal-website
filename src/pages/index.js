      ...
      <main className="bg-white px-10 md:px-20 lg:px-40">
        ...
        <section>
          <div>
            ...
            <p className="text-lg py-2 leading-8 text-gray">
          ...
          <div className="lg:flex gap-5">
            <div className="text-center shadow-lg p-10 rounded-xl my-10">
              <h3 className="text-2xl font-medium pt-8 pb-2">Education</h3>
              <p className="text-lg py-2">
                University of Massachusetts Amherst, 2019 - 2022
              </p>
              <p className="text-lg font-medium">Relevant Coursework:</p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <p className="text-md py-2 leading-8 text-gray md:text-xl">
            ...
            <div className="text-left shadow-lg p-10 rounded-xl my-10">
              ...
              <p className="text-lg font-medium">Associate Software Engineer, Liberty Mutual Insurance</p>
              <p>January 2023 - PRESENT</p>
              <br></br>
              <p><span className="text-sm font-medium">Skill:</span> Amazon Web Services (AWS) · Angular · JavaScript · Jest · Microsoft Azure · Node.js · Python (Programming Language) · TypeScript</p>
              <br></br>
              <p className="text-lg font-medium">Technology Associate, Liberty Mutual Insurance</p>
              <p>September 2022 - January 2023</p>
              <br></br>
              <p><span className="text-sm font-medium">Skill:</span> Amazon Web Services (AWS) · Angular · JavaScript · Jest · Microsoft Azure · Node.js · Python (Programming Language) · TypeScript</p>
              <br></br>
              <p className="text-lg font-medium">Software Engineer Intern, Liberty Mutual Insurance</p>
              <p>June 2022 - September 2022</p>
              <p>Full-stack development on Architecture, Cloud and Engineering Enablement Team; build cloud infrastructure and products to support application teams.</p>
              <br></br>
              <p><span className="text-sm font-medium">Skill:</span> Amazon Web Services (AWS) · Angular · JavaScript · Jest · Microsoft Azure · Node.js · Python (Programming Language) · TypeScript</p>
              <br></br>
              <p className="text-lg font-medium">Software Development Co-op, Solaria Labs</p>
              ...
              <br></br>
              <p><span className="text-sm font-medium">Skill:</span> Amazon Web Services (AWS) · Dart · Express.js · Flutter · JavaScript · MySQL · Node.js · React.js</p>
            </div>
          </div>
        </section>
      </main>
